...
if [ -n "$APK" ]; then
    cp "$APK" "$PROJETO_WIN/Instalador/RonaldoMedeirosFisiologista_v2.0.apk"
    echo "APK copiado para: C:\Users\madm\ronaldo_build\Instalador\RonaldoMedeirosFisiologista_v2.0.apk"
else
