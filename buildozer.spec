...
# Requirements para player nativo (pyjnius para Android, pyobjus para iOS)
requirements = python3,kivy==2.3.0,kivymd==1.2.0,pillow,certifi,openssl,sqlite3,requests,android,pyasn1,idna,charset-normalizer,pyjnius,urllib3,pyobjus,plyer

orientation = portrait
fullscreen = 0
android.permissions = INTERNET,READ_EXTERNAL_STORAGE,WRITE_EXTERNAL_STORAGE,READ_MEDIA_VIDEO,POST_NOTIFICATIONS

# Configuração necessária para o Android FileProvider (permite que o player externo leia o vídeo do app)
android.add_src = %(source.dir)s/xml
